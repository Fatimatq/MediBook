...
public class PatientController {
    ...
    public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest loginRequest) {
        ...
        System.out.print(patient.getPassword_Patient());
        System.out.print(loginRequest.getPassword_Patient());
        if (patient == null) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new LoginResponse("error", "User not found"));
        }

        if (! patient.getPassword_Patient().equals(loginRequest.getPassword_Patient())) {
